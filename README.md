...
This project presents an interactive Sales Analysis Dashboard built using Power BI to analyze Amazon product data. The dashboard provides insights into sales performance, product categories, customer engagement, and year-over-year growth trends.

The goal of this project is to transform raw data into meaningful business insights that can support strategic decision-making.

**Objectives**

**Problem Statement**

E-commerce platforms generate massive amounts of data, but extracting actionable insights is challenging.
